...
public class PugRescueTester {
	...
	public static void main(String[] args)
	{
		try {
			...
			for(Dog dog:testSubjects) System.out.println(dog.getBreed());
			long totalTime = System.currentTimeMillis() - startTime;

			// System.out.println("Total seconds to rescue pugs: " + totalTime/1000.0);
			printDogs(testSubjects);
	...
	public static void printDogs(ArrayList<Dog> l) {
		StringBuilder sb = new StringBuilder("[");
		for (Dog d : l) sb.append(d.getBreed()).append(", ");
